...
import { addEditFormation } from "../../../stores/reducers/formation/actions";
...
export default ({ open, handleClose, selected }) => {
  ...
  useEffect(() => {
    setNameFormation(selected ? selected.nom : null);
  ...
  const addEditFormationCallback = useCallback((data) => {
    dispatch(
      addEditFormation(
        {
  ...
  }, [dispatch, nameFormation, selected, handleClose]);
  function submitForm(data) {
    addEditFormationCallback(data);
  }
  return (
    <Dialog
      maxWidth="xs"
      ...
      <form className="modal-content" onSubmit={handleSubmit(submitForm)}>
        ...
        <DialogContent className="modal-body">
          <Controller
            ...
            rules={{ required: 'Formation\' s Title is required' }}
          />
          <Controller
            name="dateDebut"
            control={control}
